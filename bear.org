...
# Time-stamp: <2025-08-18 19:50:17 krylon>
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-08-18 Mo 19:50]
   | Headline                                        | Time      |           |         |      |      |
   |-------------------------------------------------+-----------+-----------+---------+------+------|
   | *Total time*                                    | *4d 8:24* |           |         |      |      |
   |-------------------------------------------------+-----------+-----------+---------+------+------|
   | *Care Bear [10/23]*                             | *4d 8:24* |           |         |      |      |
   | \_  /Components [12/26]/                        |           | /4d 8:24/ |         |      |      |
   | \_    Common [1/2]                              |           |           |    0:06 |      |      |
...
**** DONE [#G] Make default log level configurable
     ...
     :END:
**** TODO Make all log levels configurable
*** Model [1/1]
    :PROPERTIES:
    :COOKIE_DATA: todo recursive
    :VISIBILITY: children
